...
# Cannot use the .request() since it urllib3.request ultimately calls urlencode
# but does not pass the doseq=True (and has no option to do so).
#                    r = self.pool_manager.request(method, url,
#                                                  fields=post_params,
...
#                                                  headers=headers)
                ...
                if headers['Content-Type'] == 'text/plain':
                    r = self.pool_manager.urlopen(method,
                                                  url,
                                                  body=body,
                                                  headers=headers)
