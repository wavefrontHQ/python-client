...
class ResponseContainerIntegrationStatus(object):
    ...
    def __init__(self, status=None, response=None):
        """
        ResponseContainerIntegrationStatus - a model defined in Swagger
        """
    ...
    def status(self):
        """
        Gets the status of this ResponseContainerIntegrationStatus.
    ...
    def response(self):
        """
        Gets the response of this ResponseContainerIntegrationStatus.
