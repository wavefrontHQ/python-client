...
class Alert(object):
    ...
    def __init__(self, last_event_time=None, name=None, id=None, target=None, event=None, tags=None, target_info=None, sort_attr=None, status=None, process_rate_minutes=None, last_processed_millis=None, update_user_id=None, last_query_time=None, notificants=None, alerts_last_day=None, alerts_last_week=None, alerts_last_month=None, snoozed=None, in_maintenance_host_label_pairs=None, failing_host_label_pairs=None, active_maintenance_windows=None, prefiring_host_label_pairs=None, in_trash=None, query_failing=None, updated=None, create_user_id=None, display_expression=None, condition_qb_enabled=None, display_expression_qb_enabled=None, condition=None, condition_qb_serialization=None, display_expression_qb_serialization=None, severity=None, metrics_used=None, created=None, creator_id=None, updater_id=None, deleted=None, additional_information=None, resolve_after_minutes=None, last_failed_time=None, last_error_message=None, hosts_used=None, points_scanned_at_last_query=None, last_notification_millis=None, notification_resend_frequency_minutes=None, include_obsolete_metrics=None, created_epoch_millis=None, updated_epoch_millis=None, minutes=None):  # noqa: E501
