...
class MaintenanceWindow(object):
    ...
    def __init__(self, id=None, reason=None, customer_id=None, created_epoch_millis=None, updated_epoch_millis=None, updater_id=None, creator_id=None, relevant_host_tags_anded=None, event_name=None, title=None, start_time_in_seconds=None, end_time_in_seconds=None, relevant_customer_tags=None, relevant_host_names=None, relevant_host_tags=None, host_tag_group_host_names_group_anded=None, running_state=None):
        """
