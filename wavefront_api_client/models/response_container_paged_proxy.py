...
class ResponseContainerPagedProxy(object):
    ...
    def __init__(self, status=None, response=None):
        """
        ResponseContainerPagedProxy - a model defined in Swagger
        """
    ...
    def status(self):
        """
        Gets the status of this ResponseContainerPagedProxy.

        :return: The status of this ResponseContainerPagedProxy.
    ...
    def status(self, status):
        ...
        :param status: The status of this ResponseContainerPagedProxy.
        :type: ResponseStatus
        """
        if status is None:
