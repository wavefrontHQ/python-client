...
class DashboardParameterValue(object):
    ...
    def __init__(self, default_value=None, description=None, label=None, parameter_type=None, values_to_readable_strings=None, dynamic_field_type=None, query_value=None, hide_from_view=None, tag_key=None, multivalue=None, allow_all=None, reverse_dyn_sort=None):  # noqa: E501
