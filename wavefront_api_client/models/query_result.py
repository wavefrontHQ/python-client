...
class QueryResult(object):
    ...
    def __init__(self, query=None, name=None, skip=None, stats=None, warnings=None, metrics_used=None, hosts_used=None, host_tags_used=None, granularity=None, num_compilation_tasks=None, query_keys=None, raw_points_stats=None, summarized_points_stats=None, timeseries=None, events=None):
        ...
        if host_tags_used is not None:
          self.host_tags_used = host_tags_used
        if granularity is not None:
          self.granularity = granularity
        if num_compilation_tasks is not None:
          self.num_compilation_tasks = num_compilation_tasks
        if query_keys is not None:
          self.query_keys = query_keys
        if raw_points_stats is not None:
          self.raw_points_stats = raw_points_stats
        if summarized_points_stats is not None:
          self.summarized_points_stats = summarized_points_stats
