...
class ResponseContainerDashboard(object):
    ...
    def __init__(self):
        """
        ResponseContainerDashboard - a model defined in Swagger
    ...
    def status(self):
        """
        Gets the status of this ResponseContainerDashboard.


        :return: The status of this ResponseContainerDashboard.
    ...
    def response(self):
        """
        Gets the response of this ResponseContainerDashboard.
        The response, if the request is successful

        :return: The response of this ResponseContainerDashboard.
        :rtype: Dashboard
        """
