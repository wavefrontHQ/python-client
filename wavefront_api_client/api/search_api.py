...
class SearchApi(object):
    ...
    def search_monitored_cluster_entities(self, **kwargs):  # noqa: E501
        """Search over all the customer's non-deleted monitored clusters  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_monitored_cluster_entities(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param SortableSearchRequest body:
        :return: ResponseContainerPagedMonitoredCluster
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.search_monitored_cluster_entities_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.search_monitored_cluster_entities_with_http_info(**kwargs)  # noqa: E501
            return data

    def search_monitored_cluster_entities_with_http_info(self, **kwargs):  # noqa: E501
        """Search over all the customer's non-deleted monitored clusters  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_monitored_cluster_entities_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method search_monitored_cluster_entities" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/v2/search/monitoredcluster', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='ResponseContainerPagedMonitoredCluster',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def search_monitored_cluster_for_facet(self, facet, **kwargs):  # noqa: E501
        """Lists the values of a specific facet over the customer's non-deleted monitored cluster  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_monitored_cluster_for_facet(facet, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.search_monitored_cluster_for_facet_with_http_info(facet, **kwargs)  # noqa: E501
        else:
            (data) = self.search_monitored_cluster_for_facet_with_http_info(facet, **kwargs)  # noqa: E501
            return data

    def search_monitored_cluster_for_facet_with_http_info(self, facet, **kwargs):  # noqa: E501
        """Lists the values of a specific facet over the customer's non-deleted monitored cluster  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_monitored_cluster_for_facet_with_http_info(facet, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method search_monitored_cluster_for_facet" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'facet' is set
        if ('facet' not in params or
                params['facet'] is None):
            raise ValueError("Missing the required parameter `facet` when calling `search_monitored_cluster_for_facet`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v2/search/monitoredcluster/{facet}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def search_monitored_cluster_for_facets(self, **kwargs):  # noqa: E501
        """Lists the values of one or more facets over the customer's non-deleted monitored clusters  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_monitored_cluster_for_facets(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.search_monitored_cluster_for_facets_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.search_monitored_cluster_for_facets_with_http_info(**kwargs)  # noqa: E501
            return data

    def search_monitored_cluster_for_facets_with_http_info(self, **kwargs):  # noqa: E501
        """Lists the values of one or more facets over the customer's non-deleted monitored clusters  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_monitored_cluster_for_facets_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method search_monitored_cluster_for_facets" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/v2/search/monitoredcluster/facets', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
