...
class AlertApi(object):
    ...
    def can_user_modify(self, id, **kwargs):  # noqa: E501
        """can_user_modify  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.can_user_modify(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.can_user_modify_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.can_user_modify_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def can_user_modify_with_http_info(self, id, **kwargs):  # noqa: E501
        """can_user_modify  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.can_user_modify_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `can_user_modify`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v2/alert/{id}/canUserModify', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
