...
class UserApi(object):
    ...
    def hard_delete_user(self, id, customer_id, **kwargs):  # noqa: E501
        """hard_delete_user  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.hard_delete_user(id, customer_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: (required)
        :param str customer_id: (required)
        :return: ResponseContainerUserHardDelete
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.hard_delete_user_with_http_info(id, customer_id, **kwargs)  # noqa: E501
        else:
            (data) = self.hard_delete_user_with_http_info(id, customer_id, **kwargs)  # noqa: E501
            return data

    def hard_delete_user_with_http_info(self, id, customer_id, **kwargs):  # noqa: E501
        """hard_delete_user  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.hard_delete_user_with_http_info(id, customer_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method hard_delete_user" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `hard_delete_user`")  # noqa: E501
        # verify the required parameter 'customer_id' is set
        if ('customer_id' not in params or
                params['customer_id'] is None):
            raise ValueError("Missing the required parameter `customer_id` when calling `hard_delete_user`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/admin/api/v2/user/{id}/{customerId}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='ResponseContainerUserHardDelete',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
