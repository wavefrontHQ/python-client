...
class SavedTracesSearchApi(object):
    ...
    def create_saved_traces_search(self, **kwargs):  # noqa: E501
        """Create a search  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_saved_traces_search(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param SavedTracesSearch body: Example Body:  <pre>{   \"name\": \"beachshirts shopping\",   \"searchFilters\": {     \"filters\": [       {         \"filterType\": \"OPERATION\",         \"values\": {           \"logicalValue\": [             [               \"beachshirts.\", \"shopping.\", \"'*\"             ]           ]         }       }     ]   } }</pre>
