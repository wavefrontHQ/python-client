...
class ApiTokenApi(object):
    ...
    def create_token(self, **kwargs):  # noqa: E501
        ...
        Returns the list of all api tokens for a user. The newly created api token is the last element of returned list. <b>Note</b>: Applies only to original Tanzu Observability instances that are not onboarded to VMware Cloud services.  # noqa: E501
        ...
        :return: ResponseContainerListUserApiToken
    ...
    def create_token_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='ResponseContainerListUserApiToken',  # noqa: E501
    ...
    def delete_customer_token(self, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_customer_token_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.delete_customer_token_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def delete_customer_token_with_http_info(self, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_customer_token" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/v2/apitoken/customertokens/revoke', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_token(self, id, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_token_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_token_with_http_info(id, **kwargs)  # noqa: E501
            return data
    ...
    def delete_token_service_account(self, id, token, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_token_service_account_with_http_info(id, token, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_token_service_account_with_http_info(id, token, **kwargs)  # noqa: E501
            return data
    ...
    def delete_token_service_account_with_http_info(self, id, token, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_token_service_account" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        ...
        return self.api_client.call_api(
            '/api/v2/apitoken/serviceaccount/{id}/{token}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def generate_token_service_account(self, id, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.generate_token_service_account_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.generate_token_service_account_with_http_info(id, **kwargs)  # noqa: E501
            return data
    ...
    def generate_token_service_account_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method generate_token_service_account" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        ...
        return self.api_client.call_api(
            '/api/v2/apitoken/serviceaccount/{id}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_all_tokens(self, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_all_tokens_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_all_tokens_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def get_customer_token(self, id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str id: (required)
        :return: ResponseContainerApiTokenModel
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_customer_token_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_customer_token_with_http_info(id, **kwargs)  # noqa: E501
            return data
    ...
    def get_customer_token_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_customer_token" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and ('id' not in params or
                                                       params['id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `id` when calling `get_customer_token`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v2/apitoken/customertokens/{id}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='ResponseContainerApiTokenModel',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_customer_tokens(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :return: ResponseContainerListApiTokenModel
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_customer_tokens_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_customer_tokens_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def get_customer_tokens_with_http_info(self, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_customer_tokens" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/v2/apitoken/customertokens', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='ResponseContainerListApiTokenModel',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_tokens_service_account(self, id, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_tokens_service_account_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_tokens_service_account_with_http_info(id, **kwargs)  # noqa: E501
            return data
    ...
    def get_tokens_service_account_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_tokens_service_account" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        ...
        return self.api_client.call_api(
            '/api/v2/apitoken/serviceaccount/{id}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_token_name(self, id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str id: (required)
        :param UserApiToken body: Example Body:  <pre>{   \"tokenID\": \"Token identifier\",   \"tokenName\": \"Token name\" }</pre>
        :return: ResponseContainerUserApiToken
                 If the method is called asynchronously,
                 returns the request thread.
        """
