...
class RoleApi(object):
    ...
    def add_assignees(self, id, body, **kwargs):  # noqa: E501
        ...
        Assigns a role with a given ID to a list of user and service accounts and groups. <b>Note</b>: Applies only to original Tanzu Observability instances that are not onboarded to VMware Cloud services.  # noqa: E501
    ...
    def delete_role(self, id, **kwargs):  # noqa: E501
        ...
        Deletes a role with a given ID. <b>Note</b>: Applies only to original Tanzu Observability instances that are not onboarded to VMware Cloud services.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def grant_permission_to_roles(self, permission, body, **kwargs):  # noqa: E501
        ...
        Grants a given permission to a list of roles. <b>Note</b>: Applies only to original Tanzu Observability instances that are not onboarded to VMware Cloud services.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def remove_assignees(self, id, body, **kwargs):  # noqa: E501
        ...
        Revokes a role with a given ID from a list of user and service accounts and groups. <b>Note</b>: Applies only to original Tanzu Observability instances that are not onboarded to VMware Cloud services.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def revoke_permission_from_roles(self, permission, body, **kwargs):  # noqa: E501
        ...
        Revokes a given permission from a list of roles. <b>Note</b>: Applies only to original Tanzu Observability instances that are not onboarded to VMware Cloud services.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def update_role(self, id, body, **kwargs):  # noqa: E501
        ...
        Updates a role with a given ID. You can update the assigned groups and accounts, management properties, permissions, ID, name, and description. <b>Note</b>: Applies only to original Tanzu Observability instances that are not onboarded to VMware Cloud services.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
