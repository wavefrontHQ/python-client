...
class SecurityPolicyApi(object):
    ...
    def get_security_policy(self, type, **kwargs):  # noqa: E501
        """Get the security policy  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_security_policy(type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_security_policy_with_http_info(type, **kwargs)  # noqa: E501
        else:
            (data) = self.get_security_policy_with_http_info(type, **kwargs)  # noqa: E501
            return data

    def get_security_policy_with_http_info(self, type, **kwargs):  # noqa: E501
        """Get the security policy  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_security_policy_with_http_info(type, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_security_policy" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('type' not in params or
            ...
            raise ValueError("Missing the required parameter `type` when calling `get_security_policy`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v2/securitypolicy/{type}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_security_policy_by_version(self, type, version, **kwargs):  # noqa: E501
        """Get a specific historical version of a security policy  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_security_policy_by_version(type, version, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_security_policy_by_version_with_http_info(type, version, **kwargs)  # noqa: E501
        else:
            (data) = self.get_security_policy_by_version_with_http_info(type, version, **kwargs)  # noqa: E501
            return data

    def get_security_policy_by_version_with_http_info(self, type, version, **kwargs):  # noqa: E501
        """Get a specific historical version of a security policy  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_security_policy_by_version_with_http_info(type, version, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_security_policy_by_version" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'type' is set
        if self.api_client.client_side_validation and ('type' not in params or
                                                       params['type'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `type` when calling `get_security_policy_by_version`")  # noqa: E501
        # verify the required parameter 'version' is set
        if self.api_client.client_side_validation and ('version' not in params or
                                                       params['version'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `version` when calling `get_security_policy_by_version`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v2/securitypolicy/{type}/history/{version}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_security_policy_history(self, type, **kwargs):  # noqa: E501
        """Get the version history of security policy  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_security_policy_history(type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_security_policy_history_with_http_info(type, **kwargs)  # noqa: E501
        else:
            (data) = self.get_security_policy_history_with_http_info(type, **kwargs)  # noqa: E501
            return data

    def get_security_policy_history_with_http_info(self, type, **kwargs):  # noqa: E501
        """Get the version history of security policy  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_security_policy_history_with_http_info(type, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_security_policy_history" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'type' is set
        if self.api_client.client_side_validation and ('type' not in params or
                                                       params['type'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `type` when calling `get_security_policy_history`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v2/securitypolicy/{type}/history', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def revert_security_policy_by_version(self, type, version, **kwargs):  # noqa: E501
        """Revert to a specific historical version of a security policy  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.revert_security_policy_by_version(type, version, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.revert_security_policy_by_version_with_http_info(type, version, **kwargs)  # noqa: E501
        else:
            (data) = self.revert_security_policy_by_version_with_http_info(type, version, **kwargs)  # noqa: E501
            return data

    def revert_security_policy_by_version_with_http_info(self, type, version, **kwargs):  # noqa: E501
        """Revert to a specific historical version of a security policy  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.revert_security_policy_by_version_with_http_info(type, version, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method revert_security_policy_by_version" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'type' is set
        if self.api_client.client_side_validation and ('type' not in params or
                                                       params['type'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `type` when calling `revert_security_policy_by_version`")  # noqa: E501
        # verify the required parameter 'version' is set
        if self.api_client.client_side_validation and ('version' not in params or
                                                       params['version'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `version` when calling `revert_security_policy_by_version`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v2/securitypolicy/{type}/revert/{version}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
