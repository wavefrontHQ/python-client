...
class RecentTracesSearchApi(object):
    ...
    def create_recent_traces_search(self, **kwargs):  # noqa: E501
        """Create a search  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_recent_traces_search(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param RecentTracesSearch body: Example Body:  <pre>{   \"searchFilters\": {     \"filters\": [       {         \"filterType\": \"OPERATION\",         \"values\": {           \"logicalValue\": [             [               \"beachshirts.\", \"shopping.\", \"'*\"             ]           ]         }       }     ]   } }</pre>
